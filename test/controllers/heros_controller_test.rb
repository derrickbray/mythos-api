...
class HerosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post heros_url, params: { hero: { children: @hero.children, description: @hero.description, house: @hero.house, name: @hero.name, parents: @hero.parents, powers: @hero.powers, spouse: @hero.spouse } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { children: @hero.children, description: @hero.description, house: @hero.house, name: @hero.name, parents: @hero.parents, powers: @hero.powers, spouse: @hero.spouse } }
